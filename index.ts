...
import { Module as SonrhqCoreIdentityV1, msgTypes as SonrhqCoreIdentityV1MsgTypes } from './sonrhq.core.identity.v1'
import { Module as SonrhqProtocolVaultV1, msgTypes as SonrhqProtocolVaultV1MsgTypes } from './sonrhq.protocol.vault.v1'
import { AuthenticationAPI } from './auth';

const Client = SonrClient.plugin([
    CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBankV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosGovV1, CosmosGovV1Beta1, CosmosGroupV1, CosmosMintV1Beta1, CosmosNftV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosStakingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, IbcApplicationsInterchainAccountsControllerV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, SonrhqCoreIdentityV1, SonrhqProtocolVaultV1
]);
...
const registry = new Registry([
  ...
  ...SonrhqCoreIdentityV1MsgTypes,
  ...SonrhqProtocolVaultV1MsgTypes,

])

export {
    AuthenticationAPI as RestAPI,
    Client,
    registry,
    MissingWalletError
}
